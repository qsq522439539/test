...
class MyQQ(QToolBox):
	def __init__(self,parent=None):
		...
		toolButton1_1.setText(self.tr("QQ"))
		toolButton1_1.setIcon(QIcon("image/Q.jpg"))
		toolButton1_1.setIconSize(QSize(60,60))
		toolButton1_1.setAutoRaise(True)
		toolButton1_1.setToolButtonStyle(Qt.ToolButtonTextUnderIcon) #Qt.ToolButtonTextBesideIcon：文字显示在图标旁边。Qt.ToolButtonTextUnderIcon：文字显示在图标下面
		
		toolButton1_2=QToolButton()
		toolButton1_2.setText(self.tr("QQ"))
		toolButton1_2.setIcon(QIcon("image/Q.jpg"))
		...
		toolButton1_3.setText(self.tr("臭傻逼"))
		toolButton1_3.setIcon(QIcon("image/1.jpg"))
		...
		toolButton1_4.setText(self.tr("秦世强"))
		toolButton1_4.setIcon(QIcon("image/2.jpg"))
