...
class InputDlg(QDialog):
	def __init__(self,parent=None):
		...
		self.nameLabel.setFrameStyle(QFrame.Box|QFrame.Sunken)
		self.sexLabel=QLabel(self.tr("男"))
		self.sexLabel.setFrameStyle(QFrame.Box|QFrame.Sunken)
		self.ageLabel=QLabel("25")
		self.ageLabel.setFrameStyle(QFrame.Box|QFrame.Sunken)
		self.statureLabel=QLabel("168")
		self.statureLabel.setFrameStyle(QFrame.Box|QFrame.Sunken)

		nameButton=QPushButton(self.tr("姓名"))
		sexButton=QPushButton(self.tr("性别"))
		ageButton=QPushButton(self.tr("年龄"))
		statureButton=QPushButton(self.tr("身高"))
